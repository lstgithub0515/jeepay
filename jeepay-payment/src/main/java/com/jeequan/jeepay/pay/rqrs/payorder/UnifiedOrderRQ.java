...
public class UnifiedOrderRQ extends AbstractMchAppRQ {
    ...
    public UnifiedOrderRQ buildBizRQ(){
        ...
        else if (CS.PAY_WAY_CODE.STRIPE_PC.equals(wayCode)){
            StripePcOrderRQ bizRQ = JSONObject.parseObject(StringUtils.defaultIfEmpty(this.channelExtra, "{}"), StripePcOrderRQ.class);
            BeanUtils.copyProperties(this, bizRQ);
            return bizRQ;
        }
